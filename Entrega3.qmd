...
correlation_matrix <- cor(heartdisease[, c("age", "restbp", "chol", "maxHR", "expeak")])
...
```{r}
a<-heartdisease %>%
  select(sex,age,restbp,chol, maxHR, expeak)
